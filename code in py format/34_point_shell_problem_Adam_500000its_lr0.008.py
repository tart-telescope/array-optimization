...
optimizer = optim.Adam([x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x6, y6, x7, y7, x8, y8, x9, y9, x10, y10, x11, y11, x12, y12, x13, y13, x14, y14, x15, y15, x16, y16, x17, y17, x18, y18, x19, y19, x20, y20, x21, y21, x22, y22, x23, y23, x24, y24, x25, y25, x26, y26, x27, y27, x28, y28, x29, y29, x30, y30, x31, y31, x32, y32, x33, y33, x34, y34], lr=0.008)
#, momentum=0
steps = 500000
...
plt.savefig("34_inital_and_final_coords_Adam_500000its_lr0.0008.pdf")
plt.show()
...
plt.savefig("loss_history_34_Adam_500000its_lr0.008.pdf")