...
optimizer = optim.SGD([x1, y1, x2, y2, x3, y3, x4, y4], lr=.01, momentum=1)
...
for step in range(steps):
    ...
    perimeter_penalty = (torch.max(torch.tensor(0.), ((perimeter)**2 - (max_perimeter)**2)**1)) 
...
plt.xlim(-25, 25)
plt.ylim(-25, 25)
plt.savefig("4_points_init_final_positions_SGD_10000its_lr0.01_1mom.pdf")
...
plt.ylabel("loss")
plt.grid(color='gray', linestyle='-', linewidth=0.5)
plt.savefig("4_points_loss_history_SGD_10000its_lr0.01_1mom.pdf")
