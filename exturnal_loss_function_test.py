...
optimizer = optim.Adam([x1, y1, x2, y2, x3, y3, x4, y4], lr=.01)
...
for step in range(steps):
    ...
    # loss function
    loss = loss_function(area, perimeter_penalty)
...
plt.xlim(-25, 25)
plt.ylim(-25, 25)
plt.savefig("4_points_init_final_positions_Adam_10000its_lr0.01.pdf")
...
plt.ylabel("loss")
plt.grid(color='gray', linestyle='-', linewidth=0.5)
plt.savefig("4_points_loss_history_Adam_10000its_lr0.01.pdf")
